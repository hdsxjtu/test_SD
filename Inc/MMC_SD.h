...
//这部分应根据具体的连线来修改!
//MiniSTM32开发板使用的是PA4作为SD卡的CS脚.
#define	SD_CS_1    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_SET) 	//SD卡片选引脚	
#define	SD_CS_0    HAL_GPIO_WritePin(GPIOA,GPIO_PIN_4,GPIO_PIN_RESET)
